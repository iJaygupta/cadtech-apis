exports.emailTemplate = function (type, url) {
                                ...
                                <tr>
                                    <td class="bg_dark email-section" style="text-align:center;">
                                        <div class="heading-section heading-section-white">
                                            ...
                                            <h2>Welcome To There App</h2>
                                            <p>A Software Solution for All Mobile Users </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bg_dark-otp email-section" style="text-align:center;">
                                        <div class="heading-section heading-section-white">
                                            ${getEmailBody(type, url)}
                                        </div>
                                    </td>
                                </tr>
...
function getEmailBody(value, url) {
    let body = '';
    switch (value) {
        case 'forgotPassword':
            body = `<h3 style="margin-bottom:2px; font-family: 'Montserrat', sans-serif;text-decoration: underline";>
                            Please Click below Link to Complete your Forgot Password</h3>
        ...
        case 'userRegistration':
            body = ` <h3 style="margin-bottom:2px; font-family: 'Montserrat', sans-serif;text-decoration: underline";>
                            Please Use this Verification Code to Complete your Signup</h3>
                        <h2 style="margin-bottom:0px" ;>${url}</h2>`
            break;
    }
    return body;
}