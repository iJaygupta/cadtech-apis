                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td style="text-align: left; padding-right: 10px;">
                                                    ...
                                                    <p>A online platform where learning is made simple. Our courses and
                                                        live classes will help you to achieve bright furture.
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                                                    ...
                                                    <ul>
                                                        <li><span class="text">Sushant Lok-11 Gurugram-122001,
                                                                INDIA</span></li>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td style="text-align: right; padding-left: 5px; padding-right: 5px;">
                                                    <p><a href="#" style="color: rgba(255,255,255,.4);">Unsubscribe</a></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <td valign="top" width="50%" style="padding-top: 20px;">
                                <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
                                    ...
                                    <tr>
                                        <td class="text-services">
                                            <h3>Courses</h3>
                                            <p>We facilitate wide range of courses to fulfill your
                                                requirements.
                                            </p>
                                        </td>
                                    </tr>
            ...
            <div class="bg_white email-section">
                ...
                <div  style="text-align: center; padding: 0 30px;">
                   ...
                   <p  class="thankemail">
                    ...
                    We have received your details and appreciate you for contacting us. One of our staff will get back in touch with you soon!
